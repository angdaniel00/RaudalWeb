...
class Contrato(models.Model):
    ...
    organismo = models.ForeignKey(Organismo, on_delete=models.CASCADE, null=True, default=None)
    subcontrata = models.ForeignKey(Subcontrata, on_delete=models.CASCADE, null=True, default=None)
...
class Suplemento(models.Model):
    ...
    valor_actual_contratado = models.FloatField(default=0)
